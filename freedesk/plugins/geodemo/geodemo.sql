...
CREATE TABLE IF NOT EXISTS `vis_country` (
...
INSERT INTO `vis_country` (`country`, `country_desc`, `lat`, `long`) VALUES
('AD', 'Andorra', 42.5, 1.5),
...
('FM', 'Micronesia, Federated States of', 6.9167, 158.25),
...
('MK', 'Macedonia, the Former Yugoslav Republic of', 41.8333, 22),
('ML', 'Mali', 17, -4),
('MN', 'Mongolia', 46, 105),
...
('PS', 'Palestinian Territory, Occupied', 32, 35.25),
('PT', 'Portugal', 39.5, -8),
('PW', 'Palau', 7.5, 134.5),
('PY', 'Paraguay', -23, -58),
('QA', 'Qatar', 25.5, 51.25),
...
('TV', 'Tuvalu', -8, 178),
('TW', 'Taiwan, Province of China', 23.5, 121),
